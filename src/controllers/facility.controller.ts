...
import { create, get, update, deleteFacility, getAllFacilities, getFacilitiesByOperator, uploadImageToCloudinary, updateFacilityCapacity, updateFacilityImage, deleteImageFromCloudinary} from "../services/db/facility.service";
