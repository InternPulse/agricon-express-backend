...
import {  addFacility,getFacility, updateFacility, getAllFacility, removeFacility, uploadFacilityImage, deleteFacilityImage, updateCapacityController } from '../controllers/facility.controller';
