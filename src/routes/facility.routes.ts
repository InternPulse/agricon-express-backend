...
import { addFacility,getFacility, updateFacility, getAllFacility, removeFacility, getAllFacilitiesController, getFacilitiesByOperatorController } from '../controllers/FFacilities.controller';
