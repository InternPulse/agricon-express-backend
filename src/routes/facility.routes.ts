...
import {  addFacility,getFacility, updateFacility, getAllFacility, removeFacility, uploadFacilityImage, deleteFacilityImage } from '../controllers/facility.controller';
